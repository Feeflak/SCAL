...
impl From<DynAnimObj> for LayoutItem {
    fn from(obj: DynAnimObj) -> Self {
...
impl<T: AnimObjectTrait + 'static> From<T> for LayoutItem {
    fn from(obj: T) -> Self {
        LayoutItem::Object(DynAnimObj(Box::new(obj)))
    }
}
...
pub struct LayoutResult {
    ...
    pub container: DynAnimObj,
    pub items: Vec<DynAnimObj>,
...
fn relayout_nested_children(bg_size: Vec2, container: &LayoutContainer, items: &mut [DynAnimObj]) {
