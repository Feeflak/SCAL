...
use crate::{anim_object::object_trait::DynAnimObj, anim_op::resolve_op};
use crate::{
    anim_object::{
        Transform,
...
impl Animator {
    ...
    pub fn animate_next_frame(&mut self) -> Result<Option<FrameAnimationOutput<'_>>> {
        ...
        loop {
            let animation: Animation = resolve_op(self.anim_state.anim_op.clone())
