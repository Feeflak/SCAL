...
pub fn rotate_to(uuid: Uuid, target: f32, duration: Seconds, curve: Ease) -> Animation {
    Animation::new(
        duration,
        curve,
        Box::new(move |animator, storage| {
...
pub fn scale_to(uuid: Uuid, target: Vec2, duration: Seconds, curve: Ease) -> Animation {
    Animation::new(
        duration,
        curve,
        Box::new(move |animator, storage| {
